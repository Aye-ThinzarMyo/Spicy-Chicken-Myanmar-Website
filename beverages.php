...
$apiUrl = "http://localhost:8000/api/beveragesApiCall.php?category_id=3";
    ...
    <div class='custom-margin'>
        ...
        <div class='food-bar'>
            ...
            <li><a href="menu.php">ALL</a></li>
                ...
                <li class='active'><a href="beverages.php"  style='background-color: black; color: red;'>BEVERAGES</a></li>
