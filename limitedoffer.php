...
$apiUrl = "http://localhost:8000/api/beveragesApiCall.php?category_id=4";
...
?>
   <header class="nav-bar">
    ...
    <div class='custom-margin'>
        ...
        <div class='food-bar'>
            ...
            <li><a href="menu.php">ALL</a></li>
                <li><a href="chickenMeal.php" >CHICKEN-MEALS</a></li>
                <li><a href="comboSet.php">COMBO-SETS</a></li>
                <li><a href="beverages.php">BEVERAGES</a></li>
                <li class='active'><a href="limitedOffer.php" style='background-color: black; color: red;'>LIMITED-TIME-OFFER</a></li>
    ...
    </div><footer class="bg-black text-white py-4">
  <div class="container">
    <div class="row">
      <div class="col-md-4">
        <!-- Logo -->
